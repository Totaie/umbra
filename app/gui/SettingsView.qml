        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Mute audio stream when Umbra is not the active window")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Mutes Umbra's audio when you Alt+Tab out of the stream or click on a different window.")
                }
            }
        }
                    ...
                    onActivated : {
                        ...
                        if (StreamingPreferences.language !== new_language) {
                            ...
                            if (!StreamingPreferences.retranslate()) {
                                ToolTip.show(qsTr("You must restart Umbra for this change to take effect"), 5000)
                            }
                            else {
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Process gamepad input when Umbra is in the background")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Allows Umbra to capture gamepad inputs even if it's not the current window in focus")
                }
            }
        }
