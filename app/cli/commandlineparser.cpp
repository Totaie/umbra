...
GlobalCommandLineParser::ParseResult GlobalCommandLineParser::parse(const QStringList &args)
{
    ...
    parser.setApplicationDescription(
        "\n"
        "Starts Umbra normally if no arguments are given.\n"
        "\n"
        "Available actions:\n"
...
StreamCommandLineParser::StreamCommandLineParser()
{
    ...
    m_AudioConfigMap = {
        ...
        {"7.1.4-surround", StreamingPreferences::AC_714_SURROUND},
    };
    m_VideoCodecMap = {
...
void StreamCommandLineParser::parse(const QStringList &args, StreamingPreferences *preferences)
{
    ...
    parser.addToggleOption("mute-on-focus-loss", "mute audio when Umbra window loses focus");
